                                    ...
                                    <tr id="product">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group m-0">
                                                <input type="number" id="order_quantity" name="products[0][order_quantity]" min=1 max={{$prod->quantity}}  class="form-control" placeholder="Order Quantity">
        ...
        document.getElementById('add-product').addEventListener('click', function() {
            ...
            @enderror
                 ...
                 <td>
                        <!-- Form group start -->
                         <div class="m-0">
                           <input type="number" id="quantity" disabled class="form-control" name="products[${productIndex}][quantity]">
                           </div>
                  </td>
